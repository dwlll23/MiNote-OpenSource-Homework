...
/**
 * Notes contract class.
 * Defines all constants for ContentProvider, table columns, system folders,
 * widget types, intent extras and content URIs.
 */
public class Notes {
    ...
    public static final class TextNote implements DataColumns {
        ...
        public static final Uri CONTENT_URI =
                Uri.parse("content://" + AUTHORITY + "/text_note");
    }
